window.onload = function () {
	...
	$.get(URL + "./api/teacher/web/courselist?" + token + "&trid=089906", function(result){
	...
	$.get(URL + "./api/teacher/web/statistics?" + token+"&trid=089906", function(result){
		if (result.status == 200) {
	...
	$.get(URL + "./api/teacher/web/monthstatistics?" + token+"&trid=089906", function(result){
		if (result.status == 200) {
